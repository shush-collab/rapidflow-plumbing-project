...
void main() {
  ...
  // Boost brightness and opacity so the effect
  // is more visible under semi-transparent cards
  finalColor = clamp(finalColor * 1.6, 0.0, 1.0);
  float alpha = clamp(length(rgb) * 2.0, 0.0, 1.0) * uOpacity;
